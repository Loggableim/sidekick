...
class SupermemoryMemoryProvider(MemoryProvider):
    ...
    def get_config_schema(self):
        # Only prompt for the API key during `sidekick memory setup`.
    ...
    def initialize(self, session_id: str, **kwargs) -> None:
        ...
        self._sidekick_home = kwargs.get("hermes_home") or str(get_sidekick_home())
        self._session_id = session_id
        self._turn_count = 0
        self._config = _load_supermemory_config(self._sidekick_home)
