  ...
  return (
    ...
    >
      ...
      <Box flexDirection="column" marginTop={ui.statusBar === 'top' ? 0 : 1} position="relative">
        ...
        {!isBlocked && !composer.previewMode && (
          <>
        ...
        {!isBlocked && composer.previewMode && (
          <>
            ...
            >
              <Box width={promptWidth}>
                <PromptPrefix color={ui.theme.color.accent} promptText={'\u{1F441} PREVIEW'} width={promptWidth} />
              </Box>

              <Box flexGrow={0} flexShrink={0} width={inputColumns}>
                {(() => {
                  const previewText = [...composer.inputBuf, composer.input].join('\n').trim()
                  ...
                  return (
                    <Box flexDirection="column" paddingRight={1}>
                      <Md compact={false} t={ui.theme} text={previewText} />
                    </Box>
                  )
                })()}
              </Box>
            ...
            <Box marginLeft={promptWidth + COMPOSER_PROMPT_GAP_WIDTH} marginTop={1}>
              <Text color={ui.theme.color.muted} dimColor>
                Ctrl+P: edit  \u00B7  Enter: send  \u00B7  Esc: discard
              </Text>
            </Box>
          </>
        )}
