...
React + Ink terminal UI for Sidekick. TypeScript owns the screen. Python owns sessions, tools, model calls, and most command logic.
...
tui_gateway/
  ...
  slash_worker.py        persistent SidekickCLI subprocess for slash commands
```
