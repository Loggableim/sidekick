...
from sidekick_cli.config import get_env_value, load_env
import sidekick_cli.auth as auth_mod
...
def _seed_from_singletons(provider: str, entries: List[PooledCredential]) -> Tuple[bool, Set[str]]:
    ...
    try:
        from sidekick_cli.auth import is_source_suppressed as _is_suppressed
    except ImportError:
    ...
    if provider == "anthropic":
        ...
        try:
            from sidekick_cli.auth import resolve_qwen_runtime_credentials
...
def _seed_from_env(provider: str, entries: List[PooledCredential]) -> Tuple[bool, Set[str]]:
    ...
    try:
        from sidekick_cli.auth import is_source_suppressed as _is_source_suppressed
    except ImportError:
