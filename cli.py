...
try:
    from sidekick_cli.pt_input_extras import install_shift_enter_alias, install_ctrl_enter_alias
...
from sidekick_cli.banner import _format_context_length, format_banner_version_label
...
from sidekick_cli.browser_connect import (
...
try:
    from sidekick_cli.skin_engine import init_skin_from_config
...
from sidekick_cli.banner import build_welcome_banner
from sidekick_cli.commands import SlashCommandCompleter, SlashCommandAutoSuggest
...
from sidekick_cli.callbacks import prompt_for_secret
...
def _run_state_db_auto_maintenance(session_db) -> None:
    ...
    try:
        ...
        from sidekick_constants import get_sidekick_home as _get_sidekick_home
...
from sidekick_constants import is_termux as _is_termux_environment
...
def _get_plugin_cmd_handler_names() -> set:
    ...
    try:
        from sidekick_cli.plugins import get_plugin_commands
...
class SidekickCLI:
    ...
    def __init__(
        ...
        if self.model == _DEFAULT_CONFIG_MODEL:
            ...
            if "localhost" in _base_url or "127.0.0.1" in _base_url:
                from sidekick_cli.runtime_provider import _auto_detect_local_model
    ...
    def set_voice_record_key_cache(self, raw_key: object) -> None:
        ...
        """
        try:
            from sidekick_cli.voice import format_voice_record_key_for_status
    ...
    def _normalize_model_for_provider(self, resolved_provider: str) -> bool:
        ...
        try:
            from sidekick_cli.model_normalize import (
        ...
        if resolved_provider == "copilot":
            try:
                from sidekick_cli.models import copilot_model_api_mode, normalize_copilot_model_id
        ...
        if resolved_provider in {"opencode-zen", "opencode-go"}:
            try:
                from sidekick_cli.models import normalize_opencode_model_id, opencode_model_api_mode
    ...
    def show_banner(self):
        ...
        from sidekick_cli.model_switch import is_nous_hermes_non_agentic
    ...
    def _try_attach_clipboard_image(self) -> bool:
        ...
        """
        from sidekick_cli.clipboard import save_clipboard_image
    ...
    def _handle_snapshot_command(self, command: str):
        ...
        """
        from sidekick_cli.backup import (
    ...
    def _handle_paste_command(self):
        ...
        from sidekick_cli.clipboard import has_clipboard_image
    ...
    def show_help(self):
        ...
        from sidekick_cli.commands import COMMANDS_BY_CATEGORY

        try:
            from sidekick_cli.skin_engine import get_active_help_header
    ...
    def _show_recent_sessions(self, *, reason: str = "history", limit: int = 10) -> bool:
        ...
        from sidekick_cli.main import _relative_time
    ...
    def _handle_resume_command(self, cmd_original: str) -> None:
        ...
        # Resolve title or ID
        from sidekick_cli.main import _resolve_session_by_name_or_id
    ...
    def _run_curses_picker(self, title: str, items: list[str], default_index: int = 0) -> int | None:
        ...
        import threading
        from sidekick_cli.curses_ui import curses_single_select
    ...
    def _handle_model_picker_selection(self, persist_global: bool = False) -> None:
        ...
        if stage == "provider":
            ...
            if not model_list:
                try:
                    from sidekick_cli.models import provider_model_ids
        ...
        if stage == "model":
            ...
            if selected < len(model_list):
                from sidekick_cli.model_switch import switch_model
    ...
    def _handle_model_switch(self, cmd_original: str):
        ...
        """
        from sidekick_cli.model_switch import switch_model, parse_model_flags, list_authenticated_providers
    ...
    def _handle_curator_command(self, cmd: str):
        ...
        try:
            from sidekick_cli.curator import cli_main
            cli_main(tokens)
        except SystemExit:
    ...
    def _handle_skills_command(self, cmd: str):
        ...
        from sidekick_cli.skills_hub import handle_skills_slash
    ...
    def process_command(self, command: str) -> bool:
        ...
        from sidekick_cli.commands import resolve_command as _resolve_cmd
        ...
        if canonical in {"quit", "exit"}:
            ...
            # Check for skill slash commands (/gif-search, /axolotl, etc.)
                ...
                from sidekick_cli.commands import COMMANDS
    ...
    def _handle_skin_command(self, cmd: str):
        ...
        try:
            from sidekick_cli.skin_engine import list_skins, set_active_skin, get_active_skin_name
        except ImportError:
    ...
    def _handle_footer_command(self, cmd_original: str) -> None:
        ...
        """
        from sidekick_cli.config import load_config
        from sidekick_cli.colors import Colors as _Colors
    ...
    def _handle_fast_command(self, cmd: str):
        ...
        try:
            from sidekick_cli.models import _is_anthropic_fast_model
            agent = getattr(self, "agent", None)
            model = getattr(agent, "model", None) or getattr(self, "model", None)
    ...
    def _handle_debug_command(self):
        ...
        from sidekick_cli.debug import run_debug_share
    ...
    def _check_config_mcp_changes(self) -> None:
        ...
        from sidekick_cli.config import get_config_path as _get_config_path
    ...
    def _print_exit_summary(self):
        ...
        if msg_count > 0:
            ...
            try:
                from sidekick_cli.skin_engine import get_active_goodbye
    ...
    def _get_tui_prompt_symbols(self) -> tuple[str, str]:
        ...
        """
        try:
            from sidekick_cli.skin_engine import get_active_prompt_symbol
    ...
    def _build_tui_style_dict(self) -> dict[str, str]:
        ...
        try:
            from sidekick_cli.skin_engine import get_prompt_toolkit_style_overrides
    ...
    def run(self):
        ...
        try:
            ...
            if not is_seen(self.config, OPENCLAW_RESIDUE_FLAG) and detect_openclaw_residue():
                ...
                try:
                    from sidekick_cli.config import get_config_path as _get_cfg_path_resid
        ...
        try:
            from sidekick_cli.config import load_config
            from sidekick_cli.voice import (
