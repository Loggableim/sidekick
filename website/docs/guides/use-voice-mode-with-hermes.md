---
sidebar_position: 8
title: "Use Voice Mode with Sidekick"
description: "A practical guide to setting up and using Sidekick voice mode across CLI, Telegram, Discord, and Discord voice channels"
---

# Use Voice Mode with Sidekick
...
- you want Sidekick sitting in a Discord voice channel for live conversation
...
There are really three different voice experiences in Sidekick.
...
## Step 1: make sure normal Sidekick works first
...
Sidekick supports both local and cloud speech stacks.
...
4. Sidekick transcribes and responds
...
- asking Sidekick to structure your thoughts in real time

#### Accessibility / low-typing sessions

If typing is inconvenient, voice mode is one of the fastest ways to stay in the full Sidekick loop.

## Tuning CLI behavior

### Silence threshold

If Sidekick starts/stops too aggressively, tune:
...
Sidekick stays a normal chat bot, but can speak replies.
...
- you want Sidekick to function like a portable research or ops assistant
...
Sidekick joins a Discord VC, listens to user speech, transcribes it, runs the normal agent pipeline, and speaks replies back into the channel.
...
- Sidekick detects speech boundaries
- transcripts are posted in the associated text channel
- Sidekick responds in text and audio
