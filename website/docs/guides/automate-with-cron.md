...
description: "Real-world automation patterns using Sidekick cron — monitoring, reports, pipelines, and multi-skill workflows"
---
...
req = urllib.request.Request(URL, headers={"User-Agent": "Sidekick-Monitor/1.0"})
