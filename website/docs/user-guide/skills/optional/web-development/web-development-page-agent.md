...
- User wants **Sidekick itself to drive a browser** → use Sidekick' built-in browser tool (Browserbase / Camofox). page-agent is the *opposite* direction.
