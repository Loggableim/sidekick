...
| | |
|---|---|
| Source | Optional — install with `sidekick skills install official/research/qmd` |
...
Sidekick Agent via the native MCP client. This is the preferred
...
Then configure Sidekick Agent to connect via HTTP:
