...
| | |
|---|---|
| Source | Optional — install with `sidekick skills install official/productivity/canvas` |
...
4. Name the token (e.g., "Sidekick Agent"), set an optional expiry, and click **Generate Token**
