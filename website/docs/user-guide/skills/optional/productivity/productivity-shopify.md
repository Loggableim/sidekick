...
| | |
|---|---|
| Source | Optional — install with `sidekick skills install official/productivity/shopify` |
...
}' '{"input":{"title":"Test Hoodie","status":"DRAFT","vendor":"Sidekick","productType":"Apparel","tags":["test"]}}'
```
