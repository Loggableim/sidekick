...
| | |
|---|---|
| Source | Optional — install with `sidekick skills install official/health/neuroskill-bci` |
...
Connect Sidekick to a running [NeuroSkill](https://neuroskill.com/) instance to read
