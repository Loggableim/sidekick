...
| Version | `1.1.0` |
| Author | Sidekick Agent (adapted from obra/superpowers) |
| License | MIT |
...
> **For Sidekick:** Use subagent-driven-development skill to implement this plan task-by-task.
...
Use Sidekick tools to understand the project:
