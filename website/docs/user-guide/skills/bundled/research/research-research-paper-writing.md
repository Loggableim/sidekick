...
## Sidekick Agent Integration

This skill is designed for the Sidekick agent. It uses Sidekick tools, delegation, scheduling, and memory for the full research lifecycle.

### Related Skills

Compose this skill with other Sidekick skills for specific phases:
