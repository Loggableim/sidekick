...
sidebar_position: 2
title: "Adding Tools"
description: "How to add a new tool to Sidekick Agent — schemas, handlers, registration, and toolsets"
---
...
This page is for adding a **built-in Sidekick tool** to the repository itself.
If you want a personal, project-local, or otherwise custom tool without
modifying Sidekick core, use the plugin route instead:

- [Plugins](/docs/user-guide/features/plugins)
- [Build a Sidekick Plugin](/docs/guides/build-a-hermes-plugin)
...
- [ ] Tested with `sidekick chat -q "Use the weather tool for London"`
