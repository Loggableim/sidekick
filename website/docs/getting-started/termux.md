...
description: "Run Sidekick Agent directly on an Android phone with Termux"
---

# Sidekick on Android with Termux

This is the tested path for running Sidekick Agent directly on an Android phone through [Termux](https://termux.dev/).
...
That does not stop Sidekick from working well as a phone-native CLI agent — it just means the recommended mobile install is intentionally narrower than the desktop/server install.

---

## Option 1: One-line installer

Sidekick now ships a Termux-aware installer path:
...
### `sidekick doctor` says ripgrep or Node is missing
