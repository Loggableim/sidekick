#!/usr/bin/env python3
"""Generate llms.txt and llms-full.txt for the Sidekick docs site.
...
SECTIONS: list[tuple[str, list[tuple[str, str, str | None]]]] = [
    ...
    ("Guides & Tutorials", [
        ...
        ("guides/python-library", "Use Sidekick as a Python Library", None),
        ("guides/use-mcp-with-hermes", "Use MCP with Sidekick", None),
        ("guides/use-voice-mode-with-hermes", "Use Voice Mode with Sidekick", None),
        ("guides/use-soul-with-hermes", "Use SOUL.md with Sidekick", None),
        ("guides/build-a-hermes-plugin", "Build a Sidekick Plugin", None),
    ...
    ("Reference", [
        ...
        ("reference/skills-catalog", "Bundled Skills Catalog", "Table of all ~90 skills bundled with Sidekick"),
...
def emit_llms_full() -> str:
    ...
    seen: set[Path] = set()
    chunks: list[str] = [
        "# Sidekick Agent — Full Documentation\n",
        (
            "This file is the entire Sidekick Agent documentation concatenated for LLM "
            "context ingestion. Section order reflects docs-site navigation: Getting "
            "Started, Using Sidekick, Features, Messaging, Integrations, Guides, "
