"""
SidekickSweEnv -- SWE-Bench Style Environment with Modal Sandboxes
...
class SidekickSweEnv(SidekickAgentBaseEnv):
    ...
    name = "sidekick-swe"
    env_config_cls = SidekickSweEnvConfig

    @classmethod
    def config_init(cls) -> Tuple[SidekickSweEnvConfig, List[APIServerConfig]]:
        """
        ...
        """
        env_config = SidekickSweEnvConfig(
            ...
            tool_call_parser="sidekick",
            steps_per_eval=50,
            total_steps=500,
            use_wandb=True,
            wandb_name="sidekick-swe",
        )
