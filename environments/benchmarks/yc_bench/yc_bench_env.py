...
The evaluate flow:
    ...
    2. evaluate()  -- Iterates over all runs sequentially through:
        a. rollout_and_score_eval()  -- Per-run agent loop
            ...
            - Runs SidekickAgentLoop with terminal tool only
...
class YCBenchEvalConfig(SidekickAgentEnvConfig):
    """
    Configuration for the YC-Bench evaluation environment.

    Extends SidekickAgentEnvConfig with YC-Bench-specific settings for
...
class YCBenchEvalEnv(SidekickAgentBaseEnv):
    """
    ...
    a competing built-in agent loop). The SidekickAgentLoop then drives the
    ...
    async def setup(self):
        ...
        try:
            ...
            raise RuntimeError(
                ...
                '  pip install "sidekick-agent[yc-bench]"\n'
    ...
    async def rollout_and_score_eval(self, eval_item: Dict[str, Any]) -> Dict:
        ...
        3. Runs SidekickAgentLoop with terminal tool
        ...
        try:
            ...
            # LiteLLM), which would compete with our SidekickAgentLoop.
            ...
            # ----------------------------------------------------------
            # Step 2: Run the SidekickAgentLoop
            # ----------------------------------------------------------
