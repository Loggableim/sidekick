"""
SidekickAgentBaseEnv -- Abstract Base Environment for Hermes-Agent + Atropos
...
- Agent loop orchestration via SidekickAgentLoop
...
class SidekickAgentEnvConfig(BaseEnvConfig):
    """
...
class SidekickAgentBaseEnv(BaseEnv):
    """
    ...
    name: Optional[str] = "sidekick-agent"
    env_config_cls = SidekickAgentEnvConfig

    def __init__(
        self,
        config: SidekickAgentEnvConfig,
