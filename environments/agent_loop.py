"""
SidekickAgentLoop -- Reusable Multi-Turn Agent Engine
...
# Resized at runtime by SidekickAgentBaseEnv.__init__ via resize_tool_pool().
...
def resize_tool_pool(max_workers: int):
    ...
    Called by SidekickAgentBaseEnv.__init__ based on config.tool_pool_size.
        ...
        for turn in range(self.max_turns):
            ...
            if (
                ...
                try:
                    ...
                    fallback_parser = get_parser("sidekick")
