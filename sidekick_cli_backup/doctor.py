...
from sidekick_cli.config import get_project_root, get_hermes_home, get_env_path
...
from sidekick_cli.models import _HERMES_USER_AGENT
from sidekick_cli.vercel_auth import describe_vercel_auth
from sidekick_constants import OPENROUTER_MODELS_URL
...
from sidekick_constants import is_termux as _is_termux
...
def _build_apikey_providers_list() -> list:
    ...
    try:
        ...
        try:
            from sidekick_cli.providers import normalize_provider as _normalize_provider
...
def run_doctor(args):
    ...
    if config_path.exists():
        ...
        try:
            ...
            try:
                ...
                pass
            try:
                from sidekick_cli.config import get_compatible_custom_providers as _compatible_custom_providers
                from sidekick_cli.providers import (
            ...
            if runtime_provider and runtime_provider not in {"auto", "custom", "openrouter"}:
                try:
                    from sidekick_cli.auth import PROVIDER_REGISTRY, get_auth_status
                    ...
                    if pconfig and getattr(pconfig, "auth_type", "") == "api_key":
                        ...
                        if not configured:
                            check_fail(
                                ...
                                "(check ~/.hermes/.env or run 'sidekick setup')",
                            )
                            issues.append(
    ...
    if config_path.exists():
        try:
            from sidekick_cli.config import check_config_version, migrate_config
        ...
        try:
            from sidekick_cli.config import validate_config_structure
    ...
    from sidekick_cli.config import get_env_value
    ...
    # =========================================================================
    try:
        from sidekick_cli.profiles import list_profiles, _get_wrapper_dir, profile_exists
        import re as _re
