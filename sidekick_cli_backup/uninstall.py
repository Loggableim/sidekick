...
def uninstall_gateway_service():
    ...
    try:
        from sidekick_cli.gateway import kill_gateway_processes, find_gateway_pids
    ...
    # 3. macOS: uninstall launchd plist
        ...
        try:
            from sidekick_cli.gateway import get_launchd_plist_path
...
def _uninstall_profile(profile) -> None:
    ...
    #    Use `python -m sidekick_cli.main` so we don't depend on a `hermes`
