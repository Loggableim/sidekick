...
from sidekick_cli import auth as auth_mod
...
def _copilot_runtime_api_mode(model_cfg: Dict[str, Any], api_key: str) -> str:
    ...
    try:
        from sidekick_cli.models import copilot_model_api_mode
    ...
    *,
    ...
    if provider == "openai-codex":
        ...
        if effective_model and api_mode != "anthropic_messages":
            try:
                from sidekick_cli.models import azure_foundry_model_api_mode
        ...
        if provider in {"opencode-zen", "opencode-go"}:
            ...
            # Refs #16878.
            from sidekick_cli.models import opencode_model_api_mode
    ...
    *,
    ...
    if not api_key:
        raise AuthError(
            ...
            "~/.hermes/.env or run 'sidekick model' to configure."
        )
    ...
    *,
    ...
    if provider == "minimax-oauth":
        ...
        if pconfig and pconfig.auth_type == "oauth_minimax":
            from sidekick_cli.auth import resolve_minimax_oauth_runtime_credentials
