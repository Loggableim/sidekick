...
Usage:
    ...
    hermes uninstall           Uninstall Sidekick Agent
...
def _apply_profile_override() -> None:
    ...
    if profile_name is None:
        try:
            from sidekick_constants import get_default_hermes_root
    ...
    if profile_name is not None:
        try:
            from sidekick_cli.profiles import resolve_profile_env
...
from sidekick_cli.config import get_hermes_home
from sidekick_cli.env_loader import load_hermes_dotenv
...
try:
    from sidekick_cli.config import load_config as _load_config_early
    from sidekick_constants import apply_ipv4_preference as _apply_ipv4
...
from sidekick_constants import AI_GATEWAY_BASE_URL, OPENROUTER_BASE_URL
...
def _has_any_provider_configured() -> bool:
    ...
    from sidekick_cli.config import get_env_path, get_hermes_home, load_config
    from sidekick_cli.auth import get_auth_status

    # Determine whether Hermes itself has been explicitly configured (model
    # in config that isn't the hardcoded default). Used below to gate external
    # tool credentials (Claude Code, Codex CLI) that shouldn't silently skip
    # the setup wizard on a fresh install.
    from sidekick_cli.config import DEFAULT_CONFIG
    ...
    from sidekick_cli.auth import PROVIDER_REGISTRY
...
def _normalize_tui_toolsets(toolsets: object) -> list[str]:
    ...
    try:
        from sidekick_cli.oneshot import _normalize_toolsets
...
def _pin_kanban_board_env() -> None:
    ...
    if os.environ.get("HERMES_KANBAN_BOARD"):
        return
    try:
        from sidekick_cli.kanban_db import get_current_board
...
def cmd_chat(args):
    ...
    if not _has_any_provider_configured():
        ...
        from sidekick_cli.setup import (
    ...
    try:
        from sidekick_cli.banner import prefetch_update_check
...
def cmd_gateway(args):
    ...
    from sidekick_cli.gateway import gateway_command
...
def cmd_whatsapp(args):
    ...
    from sidekick_cli.config import get_env_value, save_env_value
...
def cmd_setup(args):
    ...
    from sidekick_cli.setup import run_setup_wizard
...
def select_provider_and_model(args=None):
    ...
    from sidekick_cli.config import (
        get_compatible_custom_providers,
        load_config,
        get_env_value,
    )
    from sidekick_cli.providers import resolve_provider_full
    ...
    from sidekick_cli.models import CANONICAL_PROVIDERS, _PROVIDER_LABELS
    ...
    def _named_custom_provider_map(cfg) -> dict[str, dict[str, str]]:
        from sidekick_cli.config import read_raw_config
...
def _clear_stale_openai_base_url():
    ...
    """
    from sidekick_cli.config import get_env_value, save_env_value, load_config
...
def _save_aux_choice(
    ...
    *,
    ...
    """
    from sidekick_cli.config import load_config, save_config
...
def _aux_select_for_task(task: str) -> None:
    ...
    """
    from sidekick_cli.config import load_config
    from sidekick_cli.model_switch import list_authenticated_providers
...
def _aux_flow_provider_model(
    ...
    from sidekick_cli.auth import _prompt_model_selection
    from sidekick_cli.models import get_pricing_for_provider
...
def _prompt_provider_choice(choices, *, default=0):
    ...
    """
    try:
        from sidekick_cli.setup import _curses_prompt_choice
...
def _model_flow_openrouter(config, current_model=""):
    ...
    from sidekick_cli.models import model_ids, get_pricing_for_provider
...
def _model_flow_ai_gateway(config, current_model=""):
    ...
    from sidekick_cli.models import ai_gateway_model_ids, get_pricing_for_provider
...
def _model_flow_nous(config, current_model="", args=None):
    ...
    from sidekick_cli.nous_subscription import prompt_enable_tool_gateway
    ...
    from sidekick_cli.models import (
    ...
    if free_tier and not model_ids:
        ...
        if unavailable_models:
            from sidekick_cli.auth import DEFAULT_NOUS_PORTAL_URL
...
def _model_flow_openai_codex(config, current_model=""):
    ...
    from sidekick_cli.codex_models import get_codex_model_ids
    ...
    if not _codex_token:
        try:
            from sidekick_cli.auth import resolve_codex_runtime_credentials
...
def _model_flow_qwen_oauth(_config, current_model=""):
    ...
    from sidekick_cli.models import fetch_api_models
...
def _model_flow_minimax_oauth(config, current_model="", args=None):
    ...
    from sidekick_cli.models import _PROVIDER_MODELS
...
def _model_flow_custom(config):
    ...
    """
    from sidekick_cli.auth import _save_model_choice, deactivate_provider
    from sidekick_cli.config import get_env_value, load_config, save_config
    ...
    from sidekick_cli.models import probe_api_models
...
def _model_flow_azure_foundry(config, current_model=""):
    ...
    * Manual entry when every probe fails (private endpoints, etc.).
    ...
    """
    from sidekick_cli.auth import _save_model_choice, deactivate_provider  # noqa: F401
    from sidekick_cli.config import (
        get_env_value,
        save_env_value,
        load_config,
...
def _remove_custom_provider(config):
    ...
    try:
        ...
        idx = menu.show()
        from sidekick_cli.curses_ui import flush_stdin
...
def _model_flow_copilot(config, current_model=""):
    ...
    from sidekick_cli.config import save_env_value, load_config, save_config
    from sidekick_cli.models import (
        fetch_api_models,
    ...
    if not api_key:
        ...
        if choice == "1":
            try:
                from sidekick_cli.copilot_auth import copilot_device_code_login
            ...
            # Validate token type
            try:
                from sidekick_cli.copilot_auth import validate_copilot_token
...
def _prompt_api_key(pconfig, existing_key: str, provider_id: str = "") -> tuple:
    ...
    from sidekick_cli.auth import LMSTUDIO_NOAUTH_PLACEHOLDER
...
def _model_flow_api_key_provider(config, provider_id, current_model=""):
    ...
    if provider_id == "lmstudio":
        ...
        from sidekick_cli.models import fetch_lmstudio_models
        ...
        from sidekick_cli.models import fetch_ollama_cloud_models
...
def _run_anthropic_oauth_flow(save_env_value):
    ...
    def _activate_claude_code_credentials_if_available() -> bool:
        ...
        if creds and (
            ...
            from sidekick_constants import display_hermes_home as _dhh_fn
...
def _model_flow_anthropic(config, current_model=""):
    ...
    from sidekick_cli.auth import get_anthropic_key
...
def cmd_login(args):
    ...
    from sidekick_cli.auth import login_command
...
def cmd_logout(args):
    ...
    from sidekick_cli.auth import logout_command
...
def cmd_auth(args):
    ...
    from sidekick_cli.auth_commands import auth_command
...
def cmd_status(args):
    ...
    from sidekick_cli.status import show_status
...
def cmd_cron(args):
    """Cron job management."""
    from sidekick_cli.cron import cron_command
...
def cmd_webhook(args):
    ...
    from sidekick_cli.webhook import webhook_command
...
def cmd_slack(args):
    ...
    if sub == "manifest":
        from sidekick_cli.slack_cli import slack_manifest_command
...
def cmd_kanban(args):
    ...
    from sidekick_cli.kanban import kanban_command
...
def cmd_hooks(args):
    ...
    from sidekick_cli.hooks import hooks_command
...
def cmd_doctor(args):
    ...
    from sidekick_cli.doctor import run_doctor
...
def cmd_dump(args):
    ...
    from sidekick_cli.dump import run_dump
...
def cmd_debug(args):
    ...
    from sidekick_cli.debug import run_debug
...
def cmd_config(args):
    ...
    from sidekick_cli.config import config_command
...
def cmd_backup(args):
    ...
    if getattr(args, "quick", False):
        from sidekick_cli.backup import run_quick_backup

        run_quick_backup(args)
    else:
        from sidekick_cli.backup import run_backup
...
def cmd_import(args):
    ...
    from sidekick_cli.backup import run_import
...
def cmd_version(args):
    ...
    try:
        from sidekick_cli.banner import check_for_updates
        from sidekick_cli.config import recommended_update_command
...
def cmd_uninstall(args):
    ...
    from sidekick_cli.uninstall import run_uninstall
...
def _gateway_prompt(prompt_text: str, default: str = "", timeout: float = 300.0) -> str:
    ...
    from sidekick_constants import get_hermes_home
...
def _install_hangup_protection(gateway_mode: bool = False):
    ...
    **intentionally left alone** — those are legitimate cancellation
    ...
    try:
        ...
        # sidekick_cli.config.get_hermes_home to simulate setup failure.
        from sidekick_cli.config import get_hermes_home as _get_hermes_home
...
def _run_pre_update_backup(args) -> None:
    ...
    try:
        from sidekick_cli.backup import create_pre_update_backup
    except Exception as exc:
        print(
    ...
    try:
        from sidekick_constants import get_hermes_home, display_hermes_home
...
def cmd_update(args):
    ...
    """
    from sidekick_cli.config import is_managed, managed_error
...
def _cmd_update_impl(args, gateway_mode: bool):
    ...
    try:
        ...
        try:
            from sidekick_cli.backup import create_quick_snapshot
        ...
        try:
            from sidekick_cli.profiles import (
                list_profiles,
                seed_profile_skills,
            )
        ...
        try:
            if sys.platform == "darwin" and shutil.which("cua-driver"):
                from sidekick_cli.tools_config import install_cua_driver
        ...
        try:
            from sidekick_cli.gateway import (
                is_macos,
...
def cmd_profile(args):
    ...
    from sidekick_constants import display_hermes_home
    ...
    if action == "list":
        ...
        from sidekick_cli.profiles import profile_exists
        ...
        from sidekick_cli.profiles import rename_profile
        ...
        from sidekick_cli.profiles import export_profile
        ...
        from sidekick_cli.profiles import import_profile
        ...
        import tempfile
        from sidekick_cli.profile_distribution import (
            plan_install,
        ...
        from sidekick_cli.profiles import get_profile_dir, normalize_profile_name
        ...
        from sidekick_cli.profile_distribution import describe_distribution, DistributionError
...
def _render_distribution_plan(plan) -> None:
    ...
    from sidekick_cli.profile_distribution import MANIFEST_FILENAME
    mf = plan.manifest
...
def cmd_dashboard(args):
    ...
    from sidekick_cli.web_server import start_server
...
def cmd_completion(args, parser=None):
    ...
    from sidekick_cli.completion import generate_bash, generate_zsh, generate_fish
...
def cmd_logs(args):
    ...
    from sidekick_cli.logs import tail_log, list_logs
...
def _build_provider_choices() -> list[str]:
    ...
    try:
        from sidekick_cli.models import CANONICAL_PROVIDERS as _cp
...
def main():
    ...
    from sidekick_cli._parser import build_top_level_parser
    ...
    # =========================================================================
    from sidekick_cli.fallback_cmd import cmd_fallback
    ...
    # =========================================================================
    from sidekick_cli.kanban import build_parser as _build_kanban_parser
...
""",
    ...
    from sidekick_cli.checkpoints import register_cli as _register_checkpoints_cli
    ...
    def cmd_pairing(args):
        from sidekick_cli.pairing import pairing_command
    ...
    def cmd_skills(args):
        ...
        if getattr(args, "skills_action", None) == "config":
            ...
            from sidekick_cli.skills_config import skills_command as skills_config_command

            skills_config_command(args)
        else:
            from sidekick_cli.skills_hub import skills_command
    ...
    def cmd_plugins(args):
        from sidekick_cli.plugins_cmd import plugins_command
    ...
    if _plugin_cli_discovery_needed():
        try:
            ...
            from sidekick_cli.plugins import discover_plugins, get_plugin_manager
    ...
    try:
        from sidekick_cli.curator import register_cli as _register_curator_cli
    ...
    def cmd_memory(args):
        ...
        if sub == "off":
            ...
            from sidekick_cli.memory_setup import memory_command
    ...
    def cmd_tools(args):
        ...
        if action in {"list", "disable", "enable"}:
            from sidekick_cli.tools_config import tools_disable_enable_command

            tools_disable_enable_command(args)
        else:
            _require_tty("tools")
            from sidekick_cli.tools_config import tools_command
    ...
    def cmd_mcp(args):
        from sidekick_cli.mcp_config import mcp_command
    ...
    def cmd_sessions(args):
        ...
        if action == "list":
            ...
            from sidekick_cli.relaunch import relaunch
    ...
    def cmd_claw(args):
        from sidekick_cli.claw import claw_command
...
""",
    ...
    from sidekick_cli.config import get_container_exec_info
    ...
    if getattr(args, "oneshot", None):
        from sidekick_cli.oneshot import run_oneshot
