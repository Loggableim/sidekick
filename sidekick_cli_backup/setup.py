...
from sidekick_cli.nous_subscription import get_nous_subscription_features
...
from sidekick_cli.colors import Colors, color
...
from sidekick_cli.cli_output import (  # noqa: E402
    print_error,
    print_info,
    print_success,
    print_warning,
...
def _curses_prompt_choice(question: str, choices: list, default: int = 0, description: str | None = None) -> int:
    ...
    from sidekick_cli.curses_ui import curses_radiolist
...
def prompt_checklist(title: str, items: list, pre_selected: list = None) -> list:
    ...
    from sidekick_cli.curses_ui import curses_checklist
...
def _print_setup_summary(config: dict, hermes_home):
    ...
    if subscription_features.image_gen.managed_by_nous:
        ...
        try:
            ...
            from sidekick_cli.plugins import _ensure_plugins_discovered
    ...
    try:
        from sidekick_cli.auth import get_provider_auth_state
    ...
    if disabled_tools:
        ...
        from sidekick_constants import display_hermes_home as _dhh
...
def setup_model_provider(config: dict, *, quick: bool = False):
    ...
    from sidekick_cli.main import select_provider_and_model
    try:
    ...
    if not quick and _supports_same_provider_pool_setup(selected_provider):
        try:
            ...
            from sidekick_cli.auth_commands import auth_add_command
...
def _write_slack_manifest_and_instruct():
    ...
    """
    try:
        from sidekick_cli.slack_cli import _build_full_manifest
...
def _setup_qqbot():
    ...
    from sidekick_cli.gateway import _setup_qqbot as _gateway_setup_qqbot
...
def setup_gateway(config: dict):
    ...
    from sidekick_cli.gateway import _all_platforms, _platform_status, _configure_platform
    ...
    if any_messaging:
        ...
        if service_running:
            if supports_systemd and _system_scope_wizard_would_need_root():
                ...
                try:
                    if supports_systemd:
                        ...
                        from sidekick_cli import gateway_windows
            ...
            from sidekick_constants import is_container
            if is_container():
...
def _model_section_has_credentials(config: dict) -> bool:
    ...
    """
    try:
        from sidekick_cli.auth import get_active_provider
...
def _get_section_config_summary(config: dict, section_key: str) -> Optional[str]:
    ...
    ``get_env_value`` is the module-level import from sidekick_cli.config
    ...
    if section_key == "model":
        ...
        from sidekick_cli.gateway import _all_platforms, _platform_status
