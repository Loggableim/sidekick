...
from sidekick_cli import __version__ as VERSION, __release_date__ as RELEASE_DATE
...
def build_welcome_banner(console: Console, model: str, cwd: str,
    ...
    try:
        ...
        if behind is not None and behind != 0:
            from sidekick_cli.config import get_managed_update_command, recommended_update_command
            if behind > 0:
