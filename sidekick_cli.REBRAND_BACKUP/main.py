...
def _run_anthropic_oauth_flow(save_env_value):
    ...
    def _activate_claude_code_credentials_if_available() -> bool:
        ...
        if creds and (
            ...
            from hermes_constants import display_sidekick_home as _dhh_fn
...
def _gateway_prompt(prompt_text: str, default: str = "", timeout: float = 300.0) -> str:
    ...
    from hermes_constants import get_sidekick_home
...
def _run_pre_update_backup(args) -> None:
    ...
    try:
        from hermes_constants import get_sidekick_home, display_sidekick_home
...
def cmd_profile(args):
    ...
    from hermes_constants import display_sidekick_home
