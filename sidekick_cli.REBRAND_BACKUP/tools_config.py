...
from sidekick_cli.nous_subscription import (
...
from sidekick_cli.cli_output import (  # noqa: E402 — late import block
...
def _get_effective_configurable_toolsets():
    ...
    try:
        from sidekick_cli.plugins import discover_plugins, get_plugin_toolsets
...
from sidekick_cli.platforms import PLATFORMS as _PLATFORMS_REGISTRY
    ...
    if post_setup_key in {"agent_browser", "browserbase"}:
        ...
        if not node_modules.exists() and npm_bin:
            ...
            if result.returncode == 0:
                ...
                _print_warning(f"    npm install failed - run manually: cd {display_sidekick_home()}/hermes-agent && npm install")
                if result.stderr:
        ...
        try:
            from sidekick_cli.auth import login_spotify_command
        except Exception as exc:
        ...
        try:
            from sidekick_cli.plugins_cmd import _get_enabled_set, _save_enabled_set
