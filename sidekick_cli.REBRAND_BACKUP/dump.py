...
from sidekick_cli.config import get_sidekick_home, get_env_path, get_project_root, load_config
...
def _gateway_status() -> str:
    ...
    try:
        from sidekick_cli.gateway import get_gateway_runtime_snapshot
