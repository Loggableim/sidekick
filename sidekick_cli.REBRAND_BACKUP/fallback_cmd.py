...
Subcommands:
  ...
  hermes fallback add      Pick provider + model via the same picker as `sidekick model`,
...
def _restore_auth_active_provider(value: Any) -> None:
    ...
    try:
        from sidekick_cli.auth import _auth_store_lock, _load_auth_store, _save_auth_store
...
def cmd_fallback_add(args) -> None:
    ...
    from sidekick_cli.main import _require_tty, select_provider_and_model
