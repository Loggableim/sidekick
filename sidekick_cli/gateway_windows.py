...
def get_task_name() -> str:
    ...
    from sidekick_cli.gateway import _profile_suffix
...
def _wait_for_gateway_ready(timeout_s: float = 6.0, interval_s: float = 0.4) -> list[int]:
    ...
    """
    from sidekick_cli.gateway import find_gateway_pids
...
def stop() -> None:
    ...
    _assert_windows()
    from sidekick_cli.gateway import kill_gateway_processes
