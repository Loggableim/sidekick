...
from sidekick_cli.auth import AuthError, resolve_provider
from sidekick_cli.colors import Colors, color
from sidekick_cli.config import get_env_path, get_env_value, get_sidekick_home, load_config
from sidekick_cli.models import provider_label
from sidekick_cli.nous_subscription import get_nous_subscription_features
from sidekick_cli.runtime_provider import resolve_requested_provider
...
def show_status(args):
    ...
    if _effective_provider_label() == "LM Studio":
        from sidekick_cli.models import probe_lmstudio_models
        model_cfg = config.get("model")
    ...
    try:
        from sidekick_cli.gateway import get_gateway_runtime_snapshot, _format_gateway_pids
