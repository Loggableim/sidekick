...
from sidekick_cli.config import get_sidekick_home
...
try:
    from sidekick_logging import setup_logging as _setup_logging
...
def _has_any_provider_configured() -> bool:
    ...
    from sidekick_cli.config import get_env_path, get_sidekick_home, load_config
...
def _run_anthropic_oauth_flow(save_env_value):
    ...
    def _activate_claude_code_credentials_if_available() -> bool:
        ...
        if creds and (
            ...
            from sidekick_constants import display_sidekick_home as _dhh_fn
...
def _install_hangup_protection(gateway_mode: bool = False):
    ...
    **intentionally left alone** — those are legitimate cancellation
    ...
    try:
        ...
        from sidekick_cli.config import get_sidekick_home as _get_sidekick_home
...
def _run_pre_update_backup(args) -> None:
    ...
    try:
        from sidekick_constants import get_sidekick_home, display_sidekick_home
