...
def _ensure_direct_aliases() -> None:
    ...
    the module attribute. This keeps `from sidekick_cli.model_switch import
...
def list_authenticated_providers(
    ...
    def _record_builtin_endpoint(slug: str) -> None:
        ...
        try:
            from sidekick_cli.auth import PROVIDER_REGISTRY as _reg
        except Exception:
            return
        pcfg = _reg.get(slug)
        if not pcfg:
    ...
    for hermes_id, mdev_id in PROVIDER_TO_MODELS_DEV.items():
        ...
        if not has_creds:
            try:
                from sidekick_cli.auth import _load_auth_store
    ...
    from sidekick_cli.providers import HERMES_OVERLAYS
    from sidekick_cli.auth import PROVIDER_REGISTRY as _auth_registry
    ...
    # with `sidekick model`).
    try:
        from sidekick_cli.models import CANONICAL_PROVIDERS as _canon_provs
    except ImportError:
        _canon_provs = []
...
def list_picker_providers(
    ...
    """
    from sidekick_cli.models import fetch_openrouter_models
