...
from sidekick_cli.auth import get_nous_auth_status
from sidekick_cli.config import get_env_value, load_config
...
def prompt_enable_tool_gateway(config: Dict[str, object]) -> set[str]:
    ...
    try:
        from sidekick_cli.setup import prompt_choice
    except Exception:
        return set()
