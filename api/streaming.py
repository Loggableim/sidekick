...
def _build_agent_thread_env(profile_runtime_env: dict | None, workspace: str, session_id: str, profile_home: str) -> dict:
    ...
    **kwargs alongside an explicit TERMINAL_CWD raises TypeError before the
    ...
    try:
        from api.config import HOST as _WEBUI_HOST, PORT as _WEBUI_PORT
    ...
    try:
        from api.browser_runtime import browser_permission_status, browser_permission_token
...
def _run_agent_streaming(
    ...
    *,
    ...
    try:
        ...
        if _ws_slug:
            try:
                from api.space_engine import get_or_create_space as _goc_ws
                from api.config import set_session_dir as _set_sd
                from api.kanban_bridge import set_workspace_kanban as _set_wk
                from api.space_engine import set_active_workspace as _set_active_space
        ...
        try:
            ...
            _agent_skills = None
            try:
                from api.space_engine import Space as _Space, get_space as _gws
                _ws_obj_2 = _gws(_ws_slug) if _ws_slug else None
                if not _ws_obj_2 and _ws_slug:
                    # Fallback: old workspace_isolation module
                    from api.workspace_isolation import get_workspace as _gws_old
