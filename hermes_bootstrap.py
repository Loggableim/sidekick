"""Windows UTF-8 bootstrap for Sidekick entry points.
...
should be imported at the very top of every Sidekick entry point
...
# Apply on import — entry points just need ``import sidekick_bootstrap``
# (or ``from sidekick_bootstrap import apply_windows_utf8_bootstrap``) at
