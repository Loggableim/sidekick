...
param(
    ...
    [ValidateNotNullOrEmpty()]
    [string]$TaskName = "SidekickWebUIAutoStart",
...
$description = "Auto-start Sidekick inside WSL at Windows logon. Runs $WslScriptPath."
...
if ($PSCmdlet.ShouldProcess($TaskName, "Register Windows Scheduled Task for Sidekick WSL autostart")) {
