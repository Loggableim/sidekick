...
# Uses get_sidekick_home() so each profile gets its own Matrix store.
from sidekick_constants import get_hermes_dir as _get_hermes_dir
...
class MatrixAdapter(BasePlatformAdapter):
    ...
    def _strip_mention(self, body: str) -> str:
        ...
        otherwise normal phrases like "Sidekick Agent" become "Agent".
        """
        if not body:
            return ""
