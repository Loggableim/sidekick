...
class SlackAdapter(BasePlatformAdapter):
    ...
    async def connect(self) -> bool:
        ...
        tokens_file = get_sidekick_home() / "slack_tokens.json"
        ...
        try:
            ...
            # manifest (see `sidekick slack manifest`). In Socket Mode, Slack
            ...
            from sidekick_cli.commands import slack_native_slashes
            import re as _re
    ...
    async def _handle_slash_command(self, command: dict) -> None:
        ...
        if slash_name in {"hermes", ""}:
            ...
            from sidekick_cli.commands import slack_subcommand_map
