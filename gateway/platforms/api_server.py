    ...
    def __init__(self, max_size: int = MAX_STORED_RESPONSES, db_path: str = None):
        ...
        if db_path is None:
            try:
                ...
                db_path = str(get_sidekick_home() / "response_store.db")
            except Exception:
                db_path = ":memory:"
        try:
        ...
        from sidekick_state import apply_wal_with_fallback
...
class APIServerAdapter(BasePlatformAdapter):
    ...
    def _ensure_session_db(self):
        ...
        Sessions are persisted to ``state.db`` so that ``sidekick sessions list``
    ...
    async def _handle_health(self, request: "web.Request") -> "web.Response":
        ...
        return web.json_response({"status": "ok", "platform": "sidekick-agent"})
