...
class WeixinAdapter(BasePlatformAdapter):
    ...
    def __init__(self, config: PlatformConfig):
        ...
        self._sidekick_home = hermes_home
    ...
    async def _poll_loop(self) -> None:
        ...
        sync_buf = _load_sync_buf(self._sidekick_home, self._account_id)
        ...
        while self._running:
            try:
                ...
                if new_sync_buf:
                    ...
                    _save_sync_buf(self._sidekick_home, self._account_id, sync_buf)
    ...
    async def send(
        ...
        try:
            ...
            for idx, chunk in enumerate(chunks):
                client_id = f"sidekick-weixin-{uuid.uuid4().hex}"
...
async def send_weixin_direct(
    *,
    ...
    token_store = ContextTokenStore(str(get_sidekick_home()))
