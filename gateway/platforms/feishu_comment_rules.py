...
Config: ~/.sidekick/feishu_comment_rules.json (mtime-cached, hot-reload).
Pairing store: ~/.sidekick/feishu_comment_pairing.json.
"""
...
# ---------------------------------------------------------------------------
#
# Uses the canonical ``get_sidekick_home()`` helper (HERMES_HOME-aware and
...
RULES_FILE = get_sidekick_home() / "feishu_comment_rules.json"
PAIRING_FILE = get_sidekick_home() / "feishu_comment_pairing.json"
