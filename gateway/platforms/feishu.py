...
class FeishuAdapter(BasePlatformAdapter):
    ...
    def __init__(self, config: PlatformConfig):
        ...
        self._dedup_state_path = get_sidekick_home() / "feishu_seen_message_ids.json"
    ...
    def _write_update_prompt_response(answer: str) -> None:
        response_path = get_sidekick_home() / ".update_response"
...
# Called by `sidekick gateway setup` via _setup_feishu() in hermes_cli/gateway.py.
# =============================================================================
