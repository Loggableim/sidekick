# Sidekick Agent v0.4.0 (v2026.3.23)
...
- **MCP server management CLI** — `sidekick mcp` commands for installing, configuring, and authenticating MCP servers with full OAuth 2.1 PKCE flow ([#2465](https://github.com/NousResearch/hermes-agent/pull/2465))
...
- Fix: show human-readable error when `sidekick setup` hits permissions error ([#2196](https://github.com/NousResearch/hermes-agent/pull/2196))
...
- Fix: disabled toolsets re-enable themselves after `sidekick tools` ([#2268](https://github.com/NousResearch/hermes-agent/pull/2268))
...
- Fix: `sidekick update` use `.[all]` extras with fallback ([#1728](https://github.com/NousResearch/hermes-agent/pull/1728))
- Fix: `sidekick update` prompt before resetting working tree on stash conflicts ([#2390](https://github.com/NousResearch/hermes-agent/pull/2390))
...
- **Interactive MCP tool configuration** in `sidekick tools` ([#1694](https://github.com/NousResearch/hermes-agent/pull/1694))
...
- **Sidekick-agent-setup** skill ([#1905](https://github.com/NousResearch/hermes-agent/pull/1905))

---

## 🔌 Plugin System Enhancements

- **TUI extension hooks** — Build custom CLIs on top of Sidekick ([#2333](https://github.com/NousResearch/hermes-agent/pull/2333))
- **`sidekick plugins install/remove/list`** commands ([#2337](https://github.com/NousResearch/hermes-agent/pull/2337))
...
- Align Sidekick setup and full-suite expectations ([#1710](https://github.com/NousResearch/hermes-agent/pull/1710))
