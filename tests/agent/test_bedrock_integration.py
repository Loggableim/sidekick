...
class TestProviderAliases:
    ...
    def test_aws_alias(self):
        from sidekick_cli.models import _PROVIDER_ALIASES
...
class TestProviderLabels:
    ...
    def test_bedrock_label(self):
        from sidekick_cli.models import _PROVIDER_LABELS
...
class TestResolveProvider:
    ...
    def test_explicit_bedrock_resolves(self, monkeypatch):
        ...
        from sidekick_cli.auth import resolve_provider
...
class TestProvidersModule:
    ...
    def test_bedrock_alias_in_providers(self):
        from sidekick_cli.providers import ALIASES
    ...
    def test_bedrock_transport_mapping(self):
        from sidekick_cli.providers import TRANSPORT_TO_API_MODE
    ...
    def test_label_override(self):
        from sidekick_cli.providers import _LABEL_OVERRIDES
