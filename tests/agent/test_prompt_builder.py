...
from sidekick_cli.nous_subscription import NousFeatureState, NousSubscriptionFeatures
...
class TestBuildContextFilesPrompt:
    ...
    def test_loads_soul_md_from_sidekick_home_only(self, tmp_path, monkeypatch):
