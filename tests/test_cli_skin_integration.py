...
from cli import SidekickCLI, _build_compact_banner, _rich_text_from_ansi
from sidekick_cli.skin_engine import get_active_skin, set_active_skin


def _make_cli_stub():
    cli = SidekickCLI.__new__(SidekickCLI)
