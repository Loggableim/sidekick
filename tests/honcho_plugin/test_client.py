...
class TestFromGlobalConfig:
    ...
    def test_reads_full_config(self, tmp_path, monkeypatch):
        ...
        # Isolate from real ~/.sidekick/honcho.json
...
class TestResolveConfigPath:
    def test_prefers_sidekick_home_when_exists(self, tmp_path):
    ...
    def test_falls_back_to_global_when_no_local(self, tmp_path):
        hermes_home = tmp_path / "hermes"
        hermes_home.mkdir()
        # No honcho.json in HERMES_HOME — also isolate ~/.sidekick so
    ...
    def test_falls_back_to_global_without_sidekick_home_env(self, tmp_path):
        fake_home = tmp_path / "fakehome"
        fake_home.mkdir()
