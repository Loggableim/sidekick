...
class TestGetSubprocessHome:
    ...
    def test_returns_none_when_sidekick_home_unset(self, monkeypatch):
        monkeypatch.delenv("HERMES_HOME", raising=False)
        from sidekick_constants import get_subprocess_home
...
class TestMakeRunEnvHomeInjection:
    ...
    def test_no_injection_when_sidekick_home_unset(self, monkeypatch):
        monkeypatch.delenv("HERMES_HOME", raising=False)
...
class TestProfileBootstrap:
    ...
    def test_profile_dirs_includes_home(self):
        from sidekick_cli.profiles import _PROFILE_DIRS
    ...
    def test_create_profile_bootstraps_home_dir(self, tmp_path, monkeypatch):
        ...
        from sidekick_cli.profiles import create_profile
