...
class TestGetDefaultHermesRoot:
    ...
    def test_no_sidekick_home_returns_native(self, tmp_path, monkeypatch):
        """When HERMES_HOME is not set, returns ~/.sidekick."""
        monkeypatch.delenv("HERMES_HOME", raising=False)
        monkeypatch.setattr(Path, "home", lambda: tmp_path)

        assert get_default_hermes_root() == tmp_path / ".hermes"

    def test_sidekick_home_is_native(self, tmp_path, monkeypatch):
        """When HERMES_HOME = ~/.sidekick, returns ~/.sidekick."""
    ...
    def test_sidekick_home_is_profile(self, tmp_path, monkeypatch):
        """When HERMES_HOME is a profile under ~/.sidekick, returns ~/.sidekick."""
        native = tmp_path / ".hermes"
    ...
    def test_sidekick_home_is_docker(self, tmp_path, monkeypatch):
        """When HERMES_HOME points outside ~/.sidekick (Docker), returns HERMES_HOME."""
    ...
    def test_sidekick_home_is_custom_path(self, tmp_path, monkeypatch):
        """Any HERMES_HOME outside ~/.sidekick is treated as the root."""
