"""Tests for get_sidekick_home() profile-mode fallback warning.
...
profile is active, get_sidekick_home() should:
  1. STILL return ~/.sidekick (raising would brick 30+ module-level callers)
...
class TestGetHermesHomeProfileWarning:
    def test_classic_mode_no_active_profile_no_warning(
        ...
        """Classic mode: no active_profile file → silent, returns ~/.sidekick."""
        result = fresh_constants.get_sidekick_home()
    ...
    def test_default_active_profile_no_warning(
        ...
        """active_profile=default → still no warning, returns ~/.sidekick."""
    ...
    def test_named_profile_unset_home_warns_once(
        ...
        fresh_constants.get_sidekick_home()
        fresh_constants.get_sidekick_home()
        err2 = capsys.readouterr().err
        assert "HERMES_HOME fallback" not in err2

    def test_sidekick_home_set_suppresses_warning(
