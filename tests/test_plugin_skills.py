...
class TestPluginSkillRegistry:
    ...
    def pm(self, monkeypatch):
        from sidekick_cli import plugins as plugins_mod
        from sidekick_cli.plugins import PluginManager
...
class TestPluginContextRegisterSkill:
    ...
    def ctx(self, tmp_path, monkeypatch):
        from sidekick_cli import plugins as plugins_mod
        from sidekick_cli.plugins import PluginContext, PluginManager, PluginManifest
