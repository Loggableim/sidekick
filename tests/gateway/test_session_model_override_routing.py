...
""".lstrip(),
    ...
    monkeypatch.setattr(gateway_run, "_sidekick_home", tmp_path)

    def fake_resolve_runtime_provider(*, requested=None, explicit_base_url=None, explicit_api_key=None):
        if requested in (None, "", "openai-codex"):
            from sidekick_cli.auth import AuthError
            raise AuthError("No Codex credentials stored. Run `sidekick auth` to authenticate.")
    ...
    import sidekick_cli.runtime_provider as runtime_provider
