...
class TestFirecrawlClientConfig:
    ...
    def test_nous_auth_token_respects_sidekick_home_override(self, tmp_path):
        """Auth lookup should read from HERMES_HOME/auth.json, not ~/.sidekick/auth.json."""
...
class TestBackendSelection:
    ...
    ``sidekick tools``.  Falls back to key-based detection for legacy/manual
    setups.
    """
