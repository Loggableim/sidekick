...
class TestHermesHomeIsolation:
    def test_hermes_bin_dir_respects_sidekick_home(self):
        """_hermes_bin_dir must use HERMES_HOME, not hardcoded ~/.sidekick."""
    ...
    def test_failure_marker_respects_sidekick_home(self):
        """_failure_marker_path must use HERMES_HOME, not hardcoded ~/.sidekick."""
    ...
    def test_get_sidekick_home_fallback(self):
        """Without HERMES_HOME set, falls back to the active OS home."""
        from tools.tirith_security import _get_sidekick_home
