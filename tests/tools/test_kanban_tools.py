...
def test_kanban_tools_hidden_without_env_var(monkeypatch, tmp_path):
    """Normal `sidekick chat` sessions (no HERMES_KANBAN_TASK) must have
    ...
    schema = registry.get_definitions(set(resolve_toolset("sidekick-cli")), quiet=True)
...
def test_worker_complete_rejects_stale_run_id(worker_env, monkeypatch):
    ...
    from sidekick_cli import kanban_db as kb
    import sidekick_cli.kanban_db as _kb
