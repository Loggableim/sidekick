...
def _skill_dir(tmp_path):
    ...
    only the temp directory — not the real ~/.sidekick/skills/."""
...
class TestExternalSkillMutations:
    ...
    caused agents to create duplicate copies in ~/.sidekick/skills/ as a
    workaround.
    """
...
# come up. The user unpins via `sidekick curator unpin <name>` to delete.
# ---------------------------------------------------------------------------
