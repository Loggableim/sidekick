...
def _restore_tool_modules():
    original_sidekick_home = os.environ.get("HERMES_HOME")
    original_modules = {
        name: module
    ...
    try:
        ...
        if original_sidekick_home is None:
            os.environ.pop("HERMES_HOME", None)
        else:
            os.environ["HERMES_HOME"] = original_sidekick_home
...
def _install_modal_test_modules(
    ...
    *,
    ...
    sys.modules["hermes_cli.config"] = types.SimpleNamespace(
        get_sidekick_home=lambda: hermes_home,
    )
