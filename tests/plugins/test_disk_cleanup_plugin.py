...
class TestIsSafePath:
    def test_accepts_path_under_sidekick_home(self, _isolate_env):
        dg = _load_lib()
    ...
    def test_rejects_outside_sidekick_home(self, _isolate_env):
        dg = _load_lib()
...
class TestBundledDiscovery:
    ...
    def test_disk_cleanup_discovered_but_not_loaded_by_default(self, _isolate_env):
        ...
        from sidekick_cli import plugins as pmod
