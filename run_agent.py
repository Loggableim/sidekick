...
from sidekick_cli.timeouts import (
...
from sidekick_cli.config import cfg_get
...
class AIAgent:
    ...
    def __init__(
        ...
        self._cache_ttl = "5m"
        try:
            from sidekick_cli.config import load_config as _load_pc_cfg
        ...
        from sidekick_logging import setup_logging, setup_verbose_logging
        ...
        if self.api_mode == "anthropic_messages":
            ...
            try:
                from sidekick_cli.config import load_config as _load_br_cfg
            ...
            if api_key and base_url:
                ...
                if base_url_host_matches(effective_base, "openrouter.ai"):
                    ...
                    from sidekick_cli.models import copilot_default_headers
        ...
        try:
            from sidekick_cli.config import load_config as _load_agent_config
        ...
        if _engine_name != "compressor":
            ...
            if _selected_engine is None:
                try:
                    from sidekick_cli.plugins import get_plugin_context_engine
    ...
    def _ensure_lmstudio_runtime_loaded(self, config_context_length: Optional[int] = None) -> None:
        ...
        try:
            from agent.model_metadata import MINIMUM_CONTEXT_LENGTH
            from sidekick_cli.models import ensure_lmstudio_model_loaded
    ...
    def switch_model(self, new_model, new_provider, api_key='', base_url='', api_mode=''):
        ...
        turn-scoped).
        """
        from sidekick_cli.providers import determine_api_mode
        ...
        if hasattr(self, "context_compressor") and self.context_compressor:
            ...
            try:
                from sidekick_cli.config import load_config, get_compatible_custom_providers
                _sm_cfg = load_config()
    ...
    def _provider_model_requires_responses_api(
        ...
        *,
        ...
        if normalized_provider == "copilot":
            try:
                from sidekick_cli.models import _should_use_copilot_responses_api
    ...
    def _copilot_headers_for_request(self, *, is_vision: bool) -> dict:
        from sidekick_cli.copilot_auth import copilot_request_headers
    ...
    def _try_refresh_nous_client_credentials(self, *, force: bool = True) -> bool:
        ...
        try:
            from sidekick_cli.auth import resolve_nous_runtime_credentials
    ...
    def _try_refresh_copilot_client_credentials(self) -> bool:
        ...
        try:
            from sidekick_cli.copilot_auth import resolve_copilot_token
    ...
    def _try_activate_fallback(self, reason: "FailoverReason | None" = None) -> bool:
        ...
        try:
            ...
            try:
                from sidekick_cli.model_normalize import normalize_model_for_provider
    ...
    def _lmstudio_reasoning_options_cached(self) -> list[str]:
        ...
        if cached is not None:
            ...
            if opts or (_time.monotonic() - ts) < 60:
                return opts
        try:
            from sidekick_cli.models import lmstudio_model_reasoning_options
    ...
    def run_conversation(
        ...
        from sidekick_logging import set_session_context
