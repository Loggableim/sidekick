#!/usr/bin/env python3
"""
Sidekick MCP Server — exposes project and session management
...
MCP config for Nova (add to config.yaml):
    mcp_servers:
      hermes-webui:
...
AI-authoring disclosure: this file was rewritten by MILO (Nova)
