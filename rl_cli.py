...
from sidekick_constants import OPENROUTER_BASE_URL, get_sidekick_home
...
def main(
    ...
    Args:
        ...
        model: Model to use for the agent (reads from ~/.sidekick/config.yaml if not provided)
    ...
    """
    # Load config from ~/.sidekick/config.yaml
    ...
    if check_server:
        ...
        if ok:
            ...
            if missing:
                ...
                print("   Add them to ~/.sidekick/.env")
            else:
