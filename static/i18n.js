...
const LOCALES = {
  ...
  status_agent_running:'Agent running',
    ...
    status_hermes_home: 'Sidekick home',
  ...
  status_agent_running:'Agente in esecuzione',
    ...
    status_hermes_home: 'Home Sidekick',
  ...
  status_agent_running:'エージェント実行中',
    ...
    status_hermes_home: 'Sidekick ホーム',
    status_started: '開始',
    status_tokens: 'トークン',
    status_updated: '更新',
  ...
  folder_add_as_space_title: '添加为工作区？',
    ...
    status_profile: '配置文件',
    status_hermes_home: 'Sidekick 主目录',
    status_started: '开始时间',
    status_tokens: '令牌',
    status_unknown: '未知',
    cmd_yolo: 'YOLO 模式切换',
  ...
  folder_add_as_space_title: '\u65b0\u589e\u70ba\u5de5\u4f5c\u5340\uff1f',
    ...
    status_profile: '個人資料',
    status_hermes_home: 'Sidekick 主目錄',
    status_started: '開始時間',
    status_tokens: 'Token',
    status_updated: '已更新',
  ...
  pt: {
    ...
    status_hermes_home: 'Diretório Sidekick',
